		...
		try{
				...
				assertArrayEquals(
						new String[] { "It", "was", "now", "about",
								"20140202","20:00:00." },
						runTest(TokenFilterType.DATE, "It was now about 2nd Feb 2014 8PM."));
				assertArrayEquals(
						new String[] {"At","20:00:00."},
						runTest(TokenFilterType.DATE, "At 8PM."));
				assertArrayEquals(
						new String[] { "20130125." },
						runTest(TokenFilterType.DATE, "25th January 2013."));
				assertArrayEquals(
						new String[] { "It", "was", "now", "how",
								"1989/19905." },
						runTest(TokenFilterType.DATE, "It was now how 1989/19905."));
				assertArrayEquals(
